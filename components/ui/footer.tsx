      ...
      <div className="w-full max-w-7xl px-6 grid grid-cols-5 gap-10">
        ...
        <div className="col-span-2">
          <p className="text-sm text-[var(--color-dim)] leading-relaxed font-medium">
            PingMatrix is a powerful and user-friendly tool designed to help you
            monitor and analyze the performance of your network. With its
            intuitive interface and comprehensive features, PingMatrix allows
            you to easily track the latency and uptime of your servers, ensuring
